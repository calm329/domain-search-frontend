...
const HomeSection = () => {
  const keywords = ["game", "web", "smart", "learn", "iphone", "eco", "yoga"];
  ...
  return (
    <section className='w-full flex-1 font-openSans flex flex-col justify-center items-center gap-8 md:gap-16  py-8'>
